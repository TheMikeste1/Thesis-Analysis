...
Here we're focussed on when the median mechanism with no preference change. Let's load specifically that data.
...
df_processed = df_processed[
    ...
    & (
        ...
        | (df_processed["coordination_mechanism"] == "Median")
    )
]
...
df_described = df_described[
    (df_described["coordination_mechanism"] == "Median") & (~df_described["shifted"])
]
...
facet.fig.suptitle("No Preference Change - Median");
```
